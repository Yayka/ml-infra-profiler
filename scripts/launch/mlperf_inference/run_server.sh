...
# ============================================================================
# run_server.sh — Start vLLM OpenAI API server for MLPerf Inference Llama3.1-8B.
#
...
#   make run-mlperf-inference-client
#
# Prerequisites:
#   - Docker image built: make build-mlperf-inference
#   - Model downloaded: make prepare-mlperf-inference-data
#
# Usage:
...
echo "=== MLPerf Inference — Llama3.1-8B vLLM API Server ==="
echo "  Image:   $IMAGE"
